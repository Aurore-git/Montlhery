...
if(isset($_POST['submit'])){
  ...
  try{
    ...
    $mail->addAddress('bmurat7@gmail.com'); // Email address where you want to receive emails (you can use any of your gmail address including the gmail address which you used as SMTP server)
