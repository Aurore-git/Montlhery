    ...
    <div class="jumbotron row p-8">
      <div class="col-12 col-md-8">
        ...
        <div class="row">
          <div>
            <p>
              Pour vous accompagner dans votre formation et vous faire progresser sur les différents points techniques importants, l’auto école Montlhéry vous propose une formation assurée par deux moniteurs d’expérience (plus de 700 motards ayant suivit leur formation). 
            </p>
          </div>
      ...
      <div class="card-custom-position col-12 col-md-4">
        <div class="card">
          ...
          />
          <div class="card-body">
            <p>Passe ton permis moto<br/>
            avec notre auto-école</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="row">
  <div class="col-12">
    <p class="text-center font-weight-bold mb-5 title-section-categories-permis-moto">Il existe depuis le 31 mai 2016 trois catégories de permis moto</p>
  </div>
</div>
<div class="row section-categories-permis-moto p-8">
  <div class="col-12 col-md-4">
    ...
    <p class="text-center">accès à la conduite des motocyclettes légères limitées à une cylindrée de 125 cm3 et dont la puissance n’excède pas 11 kW (15 CV)</p>
  </div>
  <div class="col-12 col-md-4 middle-section-categories-permis-moto">
    ...
    <p class="text-center"> accès à la conduite des motocyclettes dont la puissance est inférieure ou égale à 35 kW (47,6 CV) et d’un rapport puissance / poids inférieur ou égal à 0.2 kW/kg ( 0.27 CV/kg).</p>
    <p class="description-permis-moto-lower">*Si la moto est bridé, il faut qu’a l’origine sa puissance ne dépasse pas 70kW(95.2CV).</p>
  </div>
  <div class="col-12 col-md-4">
...
<div class="row bell-section-info-permis-moto">
  ...
  <path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2zM8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/>
      ...
      Les titulaires du permis B depuis au moins deux ans peuvent conduire une motocyclette légère sous réserve d’effectuer une formation de 7h donnant lieu à la délivrance d’une attestation de formation permettant de s’assurer et de conduire sur le territoire français uniquement.
Les personnes ayant obtenu le permis avant le 1 mars 1980 ne sont pas concernés par cette formation ainsi que celles qui étaient déja assurés sur un 125cm3 dans les 5 ans qui précédait le 1 janvier 2011.</p>
  </div>
</div>
...
<div class="row p-8 text-center section-card-skills">
  <div class="col-12 col-md-6 col-xl-3 section-card-skills">
    <div class="card card-skills">
      <p class="text-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-signpost-2-fill text-center mb-4 skills-1-svg" viewBox="0 0 16 16">
    <path d="M7.293.707A1 1 0 0 0 7 1.414V2H2a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1h5v1H2.5a1 1 0 0 0-.8.4L.725 8.7a.5.5 0 0 0 0 .6l.975 1.3a1 1 0 0 0 .8.4H7v5h2v-5h5a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1H9V6h4.5a1 1 0 0 0 .8-.4l.975-1.3a.5.5 0 0 0 0-.6L14.3 2.4a1 1 0 0 0-.8-.4H9v-.586A1 1 0 0 0 7.293.707z"/>
      ...
      Maîtriser le maniement de la moto à vitesse réduite et à vitesse plus élevée hors circulation</p>
    </div>
  </div>
  <div class="col-12 col-md-6 col-xl-3 section-card-skills">
    <div class="card card-skills">
      <p>
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-stoplights-fill text-center mb-4 skills-2-svg" viewBox="0 0 16 16">
    <path fill-rule="evenodd" d="M6 0a2 2 0 0 0-2 2H2c.167.5.8 1.6 2 2v2H2c.167.5.8 1.6 2 2v2H2c.167.5.8 1.6 2 2v1a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-1c1.2-.4 1.833-1.5 2-2h-2V8c1.2-.4 1.833-1.5 2-2h-2V4c1.2-.4 1.833-1.5 2-2h-2a2 2 0 0 0-2-2H6zm3.5 3.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0 4a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zM8 13a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/>
      ...
      Appréhender la route et circuler dans des conditions normales</p>
    </div>
  </div>
  <div class="col-12 col-md-6 col-xl-3 section-card-skills">
    <div class="card card-skills">
      <p>
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-droplet-fill text-center mb-4 skills-3-svg" viewBox="0 0 16 16">
    <path fill-rule="evenodd" d="M8 16a6 6 0 0 0 6-6c0-1.655-1.122-2.904-2.432-4.362C10.254 4.176 8.75 2.503 8 0c0 0-6 5.686-6 10a6 6 0 0 0 6 6zM6.646 4.646c-.376.377-1.272 1.489-2.093 3.13l.894.448c.78-1.559 1.616-2.58 1.907-2.87l-.708-.708z"/>
      ...
      Circuler dans des conditions difficiels et partager la route avec les autres usagers</p>
    </div>
  </div>
  <div class="col-12 col-md-6 col-xl-3 section-card-skills">
    <div class="card card-skills">
      <p>
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-patch-check-fill text-center mb-4 skills-4-svg" viewBox="0 0 16 16">
    <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z"/>
  </svg><br/>
      Pratiquer une conduite autonome, sûre et économique</p>
    </div>
  </div>
</div>
...
<div class="row p-8 formation-pistes-moto">
  ...
  <div class="col-12 col-lg-6">
    ...
    <ul>
      <li>Etude des trajectoires en courbe – virage – épingle à cheveu (une étude théorique en salle précède la mise en pratique sur route)</li>
      <li>Connaître les dangers spécifiques à la moto.</li>
      <li>Apprendre à observer</li>
      <li>Savoir se placer sur la chaussée</li>
      <li> Préparer des échappatoires en cas d’urgence. Cette formation permet aux débutants ainsi qu’aux initiés d’acquérir des bases qui leur permettront de se présenter à l’examen du permis moto avec toutes les chances de réussite, et un avenir au guidon d’une moto avec les connaissances indispensables pour allier plaisir et sécurité.</li>
    </ul>
  </div>
</div>
...
<section id="MonCollapse" class="collapse">
  <div class="row p-8">
    <div class="col-12">
      <p class="text-center">
        <div>
          <p>
                a – Avant le 1er mars 1980, la réglementation française distinguait deux catégories d’engins à 2 roues immatriculés :
  ...
  b – Entre le 1er mars 1980 et le 31 décembre 1984 Les motocyclettes sont réparties en 3 catégories auxquelles correspondent 3 permis de conduire différents :
  – motocycles de moins de 80 cm3 (permis AI) : âge requis 16 ans
  – motocycles de 80 à 400 cm3 (permis A2) : âge requis 18 ans
  – motocycles de plus de 400 cm3 (permis A3) : âge requis 18 ans

  c – Entre le 1 er janvier 1985.et le 4 iuillet 1996 Il n’existe plus que deux catégories de permis
  ...
  d – Entre le 4 juillet 1996 et le 19 janvier 2013.
  ...
  permis A1 -16 ans: accès à la conduite des motocyclettes légères limitées à une cylindrée de 125 cm3 et dont la puissance n’excède pas 11 kW (15 CV).
          </p>
      </div>
    </div>
  </div>
